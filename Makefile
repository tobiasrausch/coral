...
# Targets
TARGETS = .htslib .boost src/streq src/preprocess src/gBreak
...
src/streq: .htslib .boost $(SVSOURCES)
	$(CXX) $(CXXFLAGS) $@.cpp -o $@ $(LDFLAGS)

src/preprocess: .htslib .boost $(SVSOURCES)
	$(CXX) $(CXXFLAGS) $@.cpp -o $@ $(LDFLAGS)

src/gBreak: .htslib .boost $(SVSOURCES)
	$(CXX) $(CXXFLAGS) $@.cpp -o $@ $(LDFLAGS)
